...
// ═══════════════════════════════════════════
// LOGIN SCREEN — Neon Cyberpunk Redesign
// ═══════════════════════════════════════════
  ...
  return (
    <div style={{
      ...
      <style>{`
        ...
        @keyframes floatUp { 0% { transform: translateY(100%) scale(0.8); opacity: 0; } 100% { transform: translateY(0) scale(1); opacity: 1; } }
        @keyframes gridMove { 0% { transform: translateY(0); } 100% { transform: translateY(40px); } }
        @keyframes glowLine { 0% { width: 0; opacity: 0; } 50% { opacity: 1; } 100% { width: 100%; opacity: 0; } }
      ...
      <div className="login-left" style={{
        ...
        {/* Noise overlay */}
        <div style={{ position: "absolute", inset: 0, backgroundImage: T.noise, backgroundRepeat: "repeat", backgroundSize: "256px", pointerEvents: "none" }} />
        ...
        <div style={{ position: "absolute", top: "50%", left: "50%", width: 200, height: 200, borderRadius: "50%", background: "radial-gradient(circle, rgba(52,211,153,0.04) 0%, transparent 70%)", filter: "blur(30px)", pointerEvents: "none", transform: "translate(-50%,-50%)" }} />
        ...
        <div style={{ position: "relative", zIndex: 2, textAlign: "center", padding: "0 48px", maxWidth: 460 }}>
          ...
          <FadeIn delay={200}>
            <h1 style={{
              fontFamily: sora, fontSize: 32, fontWeight: 800, color: "#F1F5F9",
              letterSpacing: "-0.04em", lineHeight: 1.3, margin: "0 0 12px",
            }}>
              未来のWeb制作を、<br />ここから。
            </h1>
          </FadeIn>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 6, textAlign: "left" }}>
              {steps.map((step, i) => (
                <div key={i} style={{
                  ...
                  <span style={{
                    fontFamily: sora, fontSize: 10, fontWeight: 700, color: step.color,
                    letterSpacing: "0.06em", minWidth: 22, opacity: 0.8,
                  }}>
                    {step.num}
                  </span>
      ...
      <div className="login-right" style={{
        ...
        {/* Noise */}
        <div style={{ position: "absolute", inset: 0, backgroundImage: T.noise, backgroundRepeat: "repeat", backgroundSize: "256px", pointerEvents: "none", zIndex: 0 }} />
          ...
          <FadeIn delay={150}>
            <div style={{
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: 12, marginBottom: 24 }}>
                <button
                  ...
                  style={{
                    ...
                    background: hoveredBtn === "student"
                      ? `linear-gradient(135deg, #3B82F6, #2563EB)`
                      : `linear-gradient(135deg, #60A5FA, #3B82F6)`,
                    color: "#fff",
                    boxShadow: hoveredBtn === "student"
                      ? `0 0 0 1px ${neon}40, 0 4px 20px ${neon}40, 0 0 40px ${neon}15`
                      : `0 4px 16px ${neon}25`,
                    transition: "all 0.3s cubic-bezier(0.16,1,0.3,1)",
                    transform: hoveredBtn === "student" ? "translateY(-2px)" : "none",
                    position: "relative", overflow: "hidden",
                  }}
                >
                  {hoveredBtn === "student" && <div style={{ position: "absolute", inset: 0, background: `linear-gradient(135deg, transparent, ${neonVivid}15, transparent)` }} />}
                  <span style={{ display: "flex", alignItems: "center", justifyContent: "center", gap: 10, position: "relative", zIndex: 1 }}>
                    <GraduationCap size={19} /> 生徒としてログイン
                  </span>
                </button>
                ...
                <button
                  ...
                  style={{
                    ...
                    cursor: "pointer", fontFamily: sora, letterSpacing: "-0.01em",
                    background: hoveredBtn === "admin" ? "rgba(255,255,255,0.06)" : "rgba(255,255,255,0.02)",
                    border: `1px solid ${hoveredBtn === "admin" ? neon + "35" : "rgba(255,255,255,0.08)"}`,
                    color: hoveredBtn === "admin" ? "#F1F5F9" : "#94A3B8",
                    boxShadow: hoveredBtn === "admin" ? `0 0 20px ${neon}08` : "none",
                    transition: "all 0.3s cubic-bezier(0.16,1,0.3,1)",
                    transform: hoveredBtn === "admin" ? "translateY(-2px)" : "none",
                  }}
                >
                  <span style={{ display: "flex", alignItems: "center", justifyContent: "center", gap: 10 }}>
                    <BarChart3 size={19} /> 講師としてログイン
                  </span>
                </button>
              </div>
              ...
              <div style={{
                ...
                background: `linear-gradient(90deg, transparent, ${neon}30, transparent)`,
              }} />
            </div>
          </FadeIn>
        </div>
